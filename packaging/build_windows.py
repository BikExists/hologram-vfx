...
2. Portable ZIP: Packages dist/HolographicVFX into dist/HolographicVFX-v1.0.1-Windows-x64.zip
3. Inno Setup: Compiles packaging/installer.iss into dist/HolographicVFX-v1.0.1-Windows-x64-Setup.exe
