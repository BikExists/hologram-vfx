...
1. **Running directly inside a ZIP file**:
   ...
   * **Solution**: Right-click `HolographicVFX-v0.1.1-dev-Windows-x64.zip`, select **Extract All...**, and run the executable from the extracted folder.
...
2. Verify that the application name says `HolographicVFX.exe` or `HolographicVFX-v0.1.1-dev-Windows-x64-Setup.exe`.
3. Click **Run anyway**.
